...
int main(int argc, char*argv[]){
	...
	int i;
        SCC sg;
	if(argc < 4){
		cout << "Enter 3 command line arguments - #threads, #vertices initially, #time in seconds, input-file" << endl;
		return 0;
	}
